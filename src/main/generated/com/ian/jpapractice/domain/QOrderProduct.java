...
public class QOrderProduct extends EntityPathBase<OrderProduct> {
    ...
    private static final long serialVersionUID = -252915346L;
    ...
    public final com.ian.jpapractice.domain.product.QProduct product;
    ...
    public QOrderProduct(Class<? extends OrderProduct> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new com.ian.jpapractice.domain.product.QProduct(forProperty("product")) : null;
    }
