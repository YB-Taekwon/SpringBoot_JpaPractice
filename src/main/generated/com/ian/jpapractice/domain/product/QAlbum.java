...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -930138461L;
    ...
    //inherited
    public final ListPath<com.ian.jpapractice.domain.Category, com.ian.jpapractice.domain.QCategory> categories = _super.categories;
    ...
    //inherited
    public final ListPath<com.ian.jpapractice.domain.OrderProduct, com.ian.jpapractice.domain.QOrderProduct> orderProductList = _super.orderProductList;
